...
var Icon = {
  view: function view(ref) {
    ...
    return [
      mithril('svg.icon', { className: attrs.className || '', viewBox: '0 0 20 20' }, icons[attrs.name] || icons.empty)
    ]
  }
};
...
var styles$1 = {
  ...
  message: function message (isSelf) {
    var bg = isSelf ? '#bcf' : '#fff';
    return {
      background: bg,
      borderRadius: '3px',
      marginBottom: '10px',
...
var address = 'ws://vhost3.lnu.se:20080/socket/';
